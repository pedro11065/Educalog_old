...
while True: 
    ...
    def Adicionar(data):
        ...
        def add_curso(database, dados, data):
        ...
        def add_nasc(database, dados, data):
            ...
            while True:            
                ...
                if len(nasc_in) == 10:
                    ...
                    if dia > 29 and mes == 2 and ano in ano_bissexto: 
                        print("Dia inválido. #010#")
                        input("Pressione Enter para continuar...")
                        continue

                    elif dia > 28 and mes == 2 and ano not in ano_bissexto: 
                        print("Dia inválido. #011#")
                        input("Pressione Enter para continuar...")
                        continue

                    elif dia == 31 and mes not in meses_31:
